function [y1 y2 ] = TestDataAlt2(L,DLD,rDLD,rL,minv,maxv,stepsize,minv2,maxv2,stepsize2, solver,Otree,ip)
...
%   tic; t2v=powerfast4(A-D,D,100,ones(10000,1)*sqrt(tau/nn),zz2); toc
  t2v=v3(:,2);
   ...
   % [aa bb]=sort(v(:,2));
    [aa bb]=sort(t2v(:,1));
     datagood = [datagood max( size(intersect(bb(1:584),ip(1:584)),1) ,size(intersect(bb(638:1222),ip(1:584)),1))]
